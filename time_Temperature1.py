...
if __name__ == '__main__':
    bot.remove_webhook()  # Удаляем старые webhook'и
    DOMAIN = os.getenv('DOMAIN')  # Получаем доменное имя из переменных окружения
    bot.set_webhook(url=f"https://{DOMAIN}/{BOT_TOKEN}")  # Устанавливаем новый webhook
